...
import 'package:one_million_app/shared/widget/scrollable_widget.dart';
import 'package:quickalert/models/quickalert_type.dart';
import 'package:quickalert/widgets/quickalert_dialog.dart';

class CoverageTable extends ConsumerStatefulWidget {
  final num userId;
  ...
  ConsumerState<CoverageTable> createState() {
    return _CoverageTableState();
  }
}

class _CoverageTableState extends ConsumerState<CoverageTable> {
