...
class MakePayments extends ConsumerStatefulWidget {
  final num userId;
  ...
  @override
  ConsumerState<MakePayments> createState() {
    return _MakePaymentsState();
  }
}

class _MakePaymentsState extends ConsumerState<MakePayments> {
