              ...
              Expanded(
                child: Container(
                  child: TabBarView(children: [
                    Container(
                      child: buildClaimDetails(context),
                    ),
                    Container(
                      child: buildUploadDocuments(context),
                    ),
                  ]),
                ),
              )
...
Widget buildClaimDetails(BuildContext context) {
  List<File> selectedImages = [];
...
Widget buildUploadDocuments(BuildContext context) {
  List<File> selectedImages = [];
