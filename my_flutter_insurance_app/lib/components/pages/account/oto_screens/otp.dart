...
import 'package:one_million_app/components/pages/account/forgot_password_form.dart';
...
class _OtpState extends State<OtpPage> {
  ...
  Future<void> loadStatusCode() async {
    ...
    if (_statusCode != null) {
      setState(() {
        _statusCodeOTPVerify = _statusCode;
        log('Status Code : $_statusCodeOTPVerify');
      });
    }
   }
