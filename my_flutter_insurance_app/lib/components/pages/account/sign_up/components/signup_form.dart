...
import 'package:one_million_app/components/pages/account/signin/login_screen.dart';
import 'package:one_million_app/components/pages/onbording_screens/already_have_an_account_acheck.dart';
import 'package:one_million_app/components/pages/account/oto_screens/otp_signup.dart';
...
import 'package:one_million_app/components/before_pages/cores/model/user_model.dart';
...
class _SignUpFormState extends State<SignUpForm> {
  ...
  Future<void> loadStatusCode() async {
    var _statusCode = await LocalStorage().getRegistrationCode();
    if (_statusCode != null) {
      setState(() {
  ...
  Future<void> loadStatusPromoCode() async {
    var _statusCode = await LocalStorage().getSetPromoCode();
    if (_statusCode != null) {
      setState(() {
        statusCodePromoCode = _statusCode;
        log('Status Code : $statusCodePromoCode');
      });
    }
   }
